...
#let intervieweeInfo = "*Sushanta Kumar Dattagupta* is an Indian condensed matter physicist. He was Director of the S N Bose National Centre for Basic Sciences Kolkata between 1999 and 2005. In 2006 he was made the founding director of IISER Kolkata. After serving one full term there the same ministry of HRD made him the Vice-chancellor of Visva-Bharati, which is served between September 2011 and February 2016. "
#let intervieweeImage = "/authFaces/SDG.jpg"
...
#show: interview.with(
  ...
  group2: group2,
  title: title,
  interviewees: "Sushanta Dattagupta",
...
#img(path: "/images/calUni.jpg", caption: "Sushanta Dattagupta obtained his BSc. and MSc. degrees from the University of Calcutta in 1965 and 1967 respectively.", position: bottom, width:66%)
...
#img(path: "/images/brookhaven.jpg", caption: "Sushanta Dattagupta carried out his doctoral research work at Brookhaven National Laboratory between 1969 and 1973, under Martin Blume.", position: bottom, width:100%)
...
#img(path: "/images/wast.jpg", caption: "Prof. Dattagupta delivering the Annual Oration 2025 of the West Bengal Academy of Science & Technology. Prof Dattagupta talked about the historic and scientific significance of the seminal letter sent by Indian physicist Satyendra Nath Bose to Albert Einstein in 1924.", position: bottom, portrait: true)
...
#img(path: "/images/alberta.jpg", caption: "After leaving Carnegie-Mellon University, Sushanta Dattagupta worked as a post-doctoral researcher at University of Albera in Canada for a year.", position: bottom, width:90%)
...
#img(path: "/images/univH.jpg", caption: "From 1981 to 1986, Sushanta Dattagupta taught as a Reader at the School of Physics in University of Hyderabad.", position: bottom, width:90%)
...
#img(path: "/images/iiser.jpg", caption: "Sushanta Dattagupta delivering a series of lectures at the Indian Institute of Science Education and Research (IISER) Kolkata. He served as the founding director of IISER Kolkata from 2006 to 2011.", position: bottom, width:90%)
...
#img(path: "/images/SDGstage.jpg", caption: "At the release of a book on the doyen of Rabindrasangeet: Shailajaranjan Majumdar, on his 125th birth anniversary, at the Lipika auditorium of Visva-Bharati. Standing by his side is Dr. Shruti Bandyopadhyay, Principal, Sangit Bhavana.", position: top, portrait: true)
...
#img(path: "/images/visva.jpeg", caption: "In 2011, Sushanta Dattagupta was appointed as the Vice-chancellor of Visva-Bharati university. He served in that role till 2016.", position: bottom, width:90%)
