...
#img(path: "/images/sayanLab.jpg", position: bottom, caption: "First year Chemistry lab at the Salt Lake Campus of IISER.", portrait: true)
...
#img(path: "/images/sayanScienceDay.jpg", position: bottom, caption: "The first Science Day celebrations at IISER in 2010.", portrait: true)
...
#img(path: "/images/sayanVECC.jpg", position: bottom, caption: "The first batch of IISER students after a visit to the Variable Energy Cyclotron Center.")
