...
$ limsup_(n -> infinity) frac(P_(n+1)-P_n, (log P_n)^2) = 1. $
Motivated by this, he conjectured that prime gaps satisfy a similar bound.

*Conjecture 1* (Cramér’s Conjecture)\
Let $2=p_1<p_2<p_3<dots$ be the sequence of prime numbers.
 + $ "(Strong form)" limsup_(n -> infinity) frac(p_(n+1)-p_n, (log p_n)^2) = 1 $
 + $ "(Weak form)" p_(n+1)-p_n << (log p_n)^2 $
