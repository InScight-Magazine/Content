...
#img(path: "/images/raka1.svg", position: top, caption: "Left: A classical particle cannot escape from the tub. Right: A quantum particle can tunnel to the other side.", width: 80%)
