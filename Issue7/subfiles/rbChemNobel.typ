...
#let title = "Metal–Organic Frameworks (MOFs), Covalent Organic Frameworks (COFs), and My Scientific Journey with Professor Omar Yaghi"
#let authors = ("Rahul Banerjee",)
#let affiliations = ("Department of Chemical Sciences, IISER Kolkata",)
#let abstract = "Prof. Rahul Banerjee of IISER Kolkata weaves the scientific rise of MOFs and COFs with a personal journey shaped by Professor Omar Yaghi, tracing how a single paper sparked a career-long engagement with reticular chemistry. It reflects on mentorship, perseverance, and bold ideas, showing how foundational experiences in MOFs continue to inform cutting-edge research on COFs and next-generation functional materials."
#let coverImage = "chemNobel.svg"
#let authorImage = "rahul.jpg"
#let authorInfo = "*Prof. Banerjee* is an organic chemist and a professor at the department of chemical sciences of the Indian Institute of Science Education and Research Kolkata. A fellow of the Royal Society of Chemistry, he is known for his studies in the field of Metal–organic framework designing."
...
#img(path: "/images/chemNobel.png", portrait: false, position: top, caption: "A series of Isoreticular MOFs. These MOFs can be modified through rational design, endowing them with new and desirable properties. Photograph: Kind courtesy \@NobelPrize/X.")
...
Even today, his intellectual energy and passion for science remain undiminished. My interaction with Professor Omar Yaghi has not only shaped my scientific trajectory but also influenced my philosophy as a researcher and #colbreak()mentor. The belief in bold ideas, perseverance in the face of skepticism, and commitment to intellectually honest, hard work continue to define my approach to science, which is now carried forward through my work on COFs and next-generation functional materials.
#img(path: "/images/rb2.jpg", portrait: false, position: top, caption: "At the Nobel Symposium at Björkborn Manor in Karlskoga. Björkborn Manor is now a museum where visitors can go back in time and imagine what it was like when Alfred Nobel spent his summers here.")
