...
#img(path: "/images/peacekeepers_1.png", caption: "*T cells in immunity:* The schematic illustrates the dual nature of T cells. Left panel: In healthy system, T cells recognize the pathogens and eliminate infected cells. Right panel: In the absence of proper regulation, self-reactive T cells misidentify self-tissue antigens as foreign, initiating destructive inflammatory responses that are the characteristic of autoimmunity. Harmful autoreactive T cells are suppressed via peripheral immune tolerance.", position: top, width: 92%, portrait: false)
...
#img(path: "/images/peacekeepers_2.png", caption: "*Training of T cells in the thymus:* Thymic T cell development involves two major selection processes-positive and negative selection. Positive selection occurs in the thymic cortex and ensures that developing thymocytes are self-MHC restricted, while the negative selection occurs primarily in the thymic medulla and ensures the removal of self-reactive T cells.", position: top, width: 100%, portrait: false)
...
Brunkow and Ramsdell accepted the challenge of understanding the genetics behind scurfy phenotype. As limited molecular tools were available that time, they utilized the positional cloning techniques, genetic mapping, candidate gene sequencing and combinatorial breeding strategies to address this question. After years of meticulous work, they identified an insertion of two-nucleotides in a previously uncharacterized gene. It is worth noting that Brunkow and Ramsdell had to painstakingly screen multiple genes before reaching to the gene responsible for scurfy phenotype. This marks their dedication and efforts which they had put up into. Biologically, this mutation caused a frameshift and premature stop codon and thus abolishing the gene’s function. Based on sequence homology with other forkhead box genes, they named it _FOXP3_ (Forkhead box P3)#super[12].

The significance of this discovery became even more apparent when Brunkow and Ramsdell observed striking similarities between phenotype of scurfy mouse and human IPEX syndrome (Immune dysregulation, Polyendocrinopathy, Enteropathy, X-linked) and they started to suspect that IPEX is the human equivalent of scurfy mouse. Children with IPEX suffered from early-onset chronic diarrhoea, autoimmune enteropathy, and severe inflammatory skin rashes, often leading to death in infancy. Genetic analysis revealed mutations in _FOXP3_, paralleling the scurfy mouse defect#super[13,14].

This convergence of mouse genetics and human pathology established _FOXP3_ as essential for immune tolerance. It further set the stage for linking two previously independent lines of investigation- Sakaguchi’s cellular discoveries and Brunkow/Ramsdell’s search for a definitive genetic regulator of autoimmune disease in mice and humans.

== FOXP3: The master regulator of Tregs
For years, Sakaguchi’s identification of CD25⁺ regulatory T cells and Brunkow and Ramsdell’s discovery of _FOXP3_ had proceeded along parallel tracks. The unifying breakthrough came when Sakaguchi demonstrated that _Foxp3_ is selectively expressed in CD4⁺CD25⁺ Tregs#super[15]. Introducing _Foxp3_ into conventional CD4⁺T cells further led to the conversion of conventional CD4⁺ T cells into cells with suppressive function#super[15]. Not only this, the scurfy mice having mutations in _Foxp3_ were found to be completely devoid of functional Tregs, whereas mice that overexpressed _Foxp3_ carried excessive Treg cells#super[16].
...
#img(path: "/images/peacekeepers_3.png", caption: "*Mechanisms of regulatory T cells:* Regulatory T cells carry out their suppressive functions through multiple complimentary mechanisms. These include the secretion of anti-inflammatory cytokines, the consumption of IL-2 which is vital for proliferation of effector T cells and the expression of CTLA-4 which competes and binds to co-stimulatory molecules on antigen-presenting cells (APCs). This leads to reduced ability of APCs to activate naïve T cells.", position: top, width: 84%, portrait: false)
...
The discovery of Tregs and _FOXP3_ reshaped not only fundamental immunology but also the understanding of human diseases. Dysregulation of Tregs underlies a wide spectrum of pathological conditions, highlighting their central role in immune homeostasis.

*Autoimmune diseases*

Defective Tregs are now recognized as key contributors to disorders such as multiple sclerosis#super[18], rheumatoid arthritis#super[19], psoriasis#super[20], type 1 diabetes#super[21] and others. In these conditions, the failure of immune regulation allows autoreactive effector T cells to attack self-tissues, leading to chronic inflammation and progressive organ damage. The mechanistic insights into Treg biology have opened avenues for therapeutic intervention, including low-dose IL-2 therapy#super[22] to expand Treg population and engineered Treg infusions designed to restore tolerance#super[23].

*Cancer*

On the other hand, regulatory T cells play an opposite role in tumors by suppressing the anti-tumor immune responses. Cancer uses Tregs to create an immune suppressive shield and this helps tumor to grow and evade faster. Scientists are now trying to specifically target tumor-associated Tregs in order to alleviate their suppression of anti-tumor immune responses and to promote clearance of tumor#super[24].

*Transplantation*

One of the major challenges in organ transplantation is graft rejection due to alloreactive immune responses. Tregs can suppress these reactions and thus can promote long-term graft tolerance#super[25].
...
#img(path: "/images/peacekeepers_4.svg", caption: "*Nobel Prize in Physiology or Medicine 2025*:  Mary E. Brunkow [Institute for Systems Biology, Seattle], Fred Ramsdell [Sonoma Biotherapeutics, San Francisco] and Shimon Sakaguchi [Osaka University, Osaka].", position: top, width: 100%, portrait: false)
== Conclusion 
...
Their work ultimately bridged mouse and human immunology and illuminated the central role of _FOXP3_ in peripheral immune tolerance. Their discovery has opened the door to innovative therapies ranging from Treg-based interventions in autoimmune diseases, allergy, and transplantation, to strategies that modulate Treg function in cancer immunotherapy. The immune system’s peacekeepers “Tregs” stand as a testament to nature’s intricate design and the enduring power of scientific inquiry.
