...
For years, Sakaguchi’s identification of CD25⁺ regulatory T cells and Brunkow and Ramsdell’s discovery of FOXP3 had proceeded along parallel tracks. The unifying breakthrough came when Sakaguchi demonstrated that Foxp3 is selectively expressed in CD4⁺CD25⁺ Tregs15. Introducing Foxp3 into conventional CD4 T cells further led to the conversion of conventional CD4⁺ T cells into cells with suppressive function#super[15]. Not only this, the scurfy mice having mutations in Foxp3 were found to be completely devoid of functional Tregs, whereas mice that overexpressed Foxp3 carried excessive Treg cells#super[16].
...
#img(path: "/images/peacekeepers_4.jpg", caption: "*Nobel Prize in Medicine 2025:* Frederick Jay Ramsdell [Sonoma Biotherapeutics, San Francisco], Mary E. Brunkow [Institute for Systems Biology, Seattle] and Shimon Sakaguchi [Osaka University, Osaka].", position: top, width: 85%, portrait: false)
== Conclusion 
