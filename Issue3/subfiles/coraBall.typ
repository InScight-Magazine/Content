...
#v-image(path: "/images/coral.jpg", caption: "Coral Structures in the ocean", position : bottom)
...
#v-image(path: "/images/coraballyellow1.png", caption: "The Cora Ball’s hydrodynamics are inspired from the motion of Coral Reefs to trap food particles from the ocean water", position:top)

#v-image(path: "/images/rachel-miller.jpeg", caption: " **Rachel Miller — A Visionary Environmentalist Driven by a Passion for Ocean Conservation", position:bottom)
...
#v-image(path: "/images/teamphoto.png", caption: "Rachel Miller, James R. Lyne, and Brooke Winslow — Passionate Environmental Advocates and Founders United by Their Commitment to Ocean Conservation.", position: top)

The Cora Ball can be easily cleaned by parting the stalks and removing the fibre mass and discarding it into the trash. The Cora Ball also doesn’t have to be cleaned every day. The fibres need to be removed only when it becomes a sizeable mass. With the Cora Ball you ensure that microfibers do not get carried to water bodies and prevent harm to the aquatic life and the ecosystem as a whole. Later the Cora Ball is to be cleaned and becomes ready for future use again. #colbreak() Miller claims that even if just 10% of US households used the Cora Ball it would prevent an equivalent of 30 million water bottles from washing into public water bodies every year. It reduces microfiber pollution by 31% as the numbers suggest. Although it is not yet available in every country including India but Miller and her team aspire to soon turn over this fact and make Cora Ball available to combat micro-fibre pollution globally.
...
#auth-profile(
  ...
  info: "Tisha Dash is a final-year BS-MS student currently pursuing her Master’s thesis in the Membrane Trafficking and Copper Metabolism Lab at IISER Kolkata, under the guidance of Dr. Arnab Gupta. Her research focuses on understanding cellular signaling pathways involved in copper homeostasis.",
  width: 80%,
)
