...
#auth-profile(
  imagePath: "/images/sayanFace.jpeg",
  info: "*Sayan Choudhury* is a theoretical physicist based at HRI Allahabad. He is an alumnus of the very first batch of IISER Kolkata (06MS). He can be reached at sayanchoudhury\@hri.res.in",
  width: 90%,
)
