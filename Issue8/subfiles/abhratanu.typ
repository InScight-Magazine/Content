...
#let title = "Finite Points, “Infinity Lines” and a Couple of Nice Proofs" 
...
#let affiliations = "Department of Mathematics and Statistics, IISER Kolkata"
// affiliations has properties exactly same as authors
// multi-author example: #let affiliations = ("Insti 1", "Insti 2")

#let authorInfo = "*Abhratanu Ray* is a 4th year student at DMS, IISER Kolkata. He is interested in algebraic topology and stochastic processes. Above all, he enjoys solving problems and wishes to apply his skills in the world of finance and business strategy in the near future."
...
#let coverImage = "/covers/abhratanu.svg"
#let authorImage = "/authFaces/abhratanu.jpeg"
...
#importantFill(
  [
  *Problem:* Prove that it is not possible to arrange any finite number of real
  points so that a straight line through every two of them shall pass
  through a third, unless they all lie in the same straight line. 
...
#img(path: "/images/abhratanu1.png", portrait: true, float: false)
...
On first instinct, proof by contradiction seems to be
...
problems as Melchior's. 

We list 2 standard definitions for
our proofs:
...
#importantFill([
*Theorem 1.1:* #strong[\(Sylvester-Gallai Theorem)] Every such set P determines at
least one ordinary line.], 2)
...
parallel, in the affine plane.], 1)
...
diagrammatic form.
#img(path: "/images/abhratanu3.png", portrait: false, float: false)
