...
#let title = "Bridging Lab Dreams to Market Realities: Why Science Needs Management Now?"
...
#let authorInfo = "*Sarvaggya Goel* is  the 2018-2023 BS-MS Gold Medalist in Chemical Sciences from IISER Kolkata. She blends strong scientific foundations with management expertise through her PGDM in Operations Management. Recognized with the IFERD Excellence Award, she consistently demonstrates academic and professional excellence."
...
#let abstract = "Brilliant scientific discoveries often fail to reach society--not due to lack of innovation, but due to lack of management insight. This article examines the widening gap between laboratory breakthroughs and market implementation, particularly in the Indian research ecosystem, where commercialization bottlenecks limit societal impact."
