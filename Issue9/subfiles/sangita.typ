...
#let title = "The Beautiful Probability of Dreams: Journey to IISER Berhampur" 
...
#show: article.with(
  ...
  authorImageWidth: 90%,
  refsFile: "/dataFiles/sangita.yml",
  // breakAfter: (-1,),
)
...
#img(path: "/images/sangita-2.jpg", caption: "With B.Math Student, 2025 Batch at ISI Bangalore.", position: top, width:80%)
...
#img(path: "/images/sangita-4.jpg", caption: "With Prof. Bernard De Baets, Department of Data Analysis and Mathematical Modelling,Ghent University,  during visit in 2022.", position: top, width: 80%)
...
#img(path: "/images/sangita-3.jpg", caption: "With Prof. Hans De Meyer, Department of Mathematics, Computer Science and Statistics,  Ghent University, during visit in 2022", portrait: true, position: top)

// #img(path: "/images/sangita-1.jpg", caption: "Analogy between _Sudoku_ and _Conformal Bootstrap_: solving theory using consistency conditions.")
