...
#show: section.with(
  ...
  coverCaption: "In the swamps of the Carboniferous, life towered and fluttered in humid air. This scene mirrors the article’s journey through time, where giant dragonflies and ancient forests breathe again through science.",
...
#dcap("Let's take a walk back in time. To be specific, let's go to 320 million years ago, to a period called the Carboniferous. At a cursory glance it would look quite similar to modern rainforests. Until you take a closer look at the trees and you realize that all of the “trees” are massive towering ferns. Ferns as big as modern seed bearing trees.")
...
Taking these things into account we landed on the group OdonataAll these criteria are met by a few groups of insects, one of them being Odonates. These represent dragonflies and damselflies. Not only are their wings quite commonly fossilized but their wing size has a direct correlation with their actual body mass. 

#img(path: "/images/atri2.jpg", caption: "Graph showing variation in Odonate wing size through time. Each dot represents a data point and the vertical bar represents variance in wing size data from that time point. We take log of wing size instead of raw values since it helps clear our noise.", position: bottom, width: 100%, portrait: true)
...
#img(path: "/images/atri3.jpg", caption: "Forster and Hirst 2012. This graph shows how body size of terrestrial, freshwater and marine species responds to temperature. Size changes are expressed as a percentage change from the organism’s size at 20 °C; each line represents a single species. n, number of species. We can see that positive change in mass happens at lower temperatures.", position: top, width: 100%, portrait: true)
...
For an abnormally large insect to not suffocate, there needs to be an abnormally high amount of oxygen in the air. Luckily in the Carboniferous, oxygen content was in fact very high, 35% to be precise. If we look at pO2 concentration throughout the Phanerozoic, the Carboniferous is the point of highest O2 content. Coincidentally it would seem that the largest insect sizes were attained at this time.

#img(path: "/images/atri4.png", caption: "Payne et al 2011. This graph represents atmospheric oxygen concentration through time. We can see that the highest values on the y axis appear during the “Carboniferous” and late “Permian”. We can compare them to current day O2 saturation by looking at the y axis value when age is 0 in the graph (this point represents present day).", position: top, width: 100%, portrait: true)
...
#img(path: "/images/atri6.jpg", caption: "Odonate wing size and tropical temperature through time. The blue line represents wing size (log in mm) and the red line represents temperature in degrees celsius. Both datasets are overlaid over each other so that we can visually see the negative correlation between them.", position: bottom, width: 100%, portrait: true)
...
This confirms our suspicions that O#sub("2") saturation alone is not controlling body size of insects. The Carboniferous period had the lowest temperatures and the highest O#sub("2") saturation. This led to odonate body sizes reaching an all time high. Following that we observe a sharp drop in body size. At this time there was a rapid increase in temperature due to the Permian extinction accompanied by a decrease in O#sub("2") saturation. In the Mesozoic (252 to 66 mya) we see that temperatures shift to lower values similar to the Carboniferous (359 to 299 mya) a few times but there isn’t a proportional response in insect body size. This is likely due to the fact that the mesozoic was plagued by low O#sub("2") saturation values. 

In the Cenozoic despite O#sub("2") values being relatively high and temperature dropping to levels lower than the average in Mesozoic there is no real response in body size of insects.. Predation pressure can play a big role in the evolution of a lineage. 
