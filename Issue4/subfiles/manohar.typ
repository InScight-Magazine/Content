...
#let title = "Solar Energy and Weather"
#let authors = ("Dr. Manohar Lal",)
#let affiliations = ("Associate Professor, Indian Institute of Geomagnetism",)
#let abstract = "*Did you know the Sun isn’t just lighting our days - it’s also powering our weather forecasts and solar panels?* While sunspots and solar flares barely tweak sunlight’s strength, they can actually nudge our climate; think rain patterns shifting or dry spells settling in. Imagine if, by tracking those solar signals, we could better predict cloudy days or droughts, making solar energy smarter and more reliable, and achieve sharper forecasts and greener power planning."
#let coverImage = "manoharCover.png"
...
#h-image(
  path: "/images/solar_spots_flares.png", 
  caption: "*a)* The black spots visible in the solar disk are the _Sun-spots_, which are the basic measure of solar activity. 
  
  *b)* Bursts of electromagnetic energy, _Solar-flares_, produced by an active Sun.", position: bottom, width: 70%
)
...
#h-image(path: "/images/ocean_circ.jpg", caption: "Ocean Circulation, redistributing heat from the equator to the poles, would bring changes in weather and climate.", position: top, width: 75%)
