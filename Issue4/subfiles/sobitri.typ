...
#let title = "A Century of Quantum Mechanics: From Paradoxes to Possibilities"
#let authors = ("Sobitri Sen",)
#let affiliations = ("NIT Manipur and IISER Kolkata",)
...
#let coverImage = "quantum.svg"
#let authorInfo = "*Dr. Sobitri Sen* is a post-doctoral research associate at NIT Manipur and visiting scientist at IISER Kolkata. She is a curious mind who feels and writes about scientific topics using literature to make it a treat to read."
#let coverCaption = "Computer simulation of Higgs boson production in the LHC collision. The discovery of the Higgs field in 2012 completed the standard model. (c) CERN. Credit: Lucas Taylor"
#let authorImage = "sobitri.jpeg"
#let refsFile = "/dataFiles/sobitriRefs.yml"
#let category = "Physics"
#let reviewedBy = ("Ayan Biswas", "Sharanya Chatterjee", "Abhirup Mukherjee")
#let received = (day: 10, month: 3, year: 2025)
...
#dcap("In 2026, the global scientific community will celebrate 100 years of quantum mechanics - a theory that has transformed how we understand nature and helped shape today’s technologies. Born in the early 20th century from experiments that defied the rules of classical physics, quantum mechanics has since become central to physics, chemistry, materials science, computing, and even our understanding of life itself. As we mark this centennial, this article looks back at its historical origins, explores how it continues to shape new discoveries, and considers what the next century of quantum science may bring.")

#v-image(path: "/images/timeline.svg", caption: "A visual journey through the major milestones in the development of quantum mechanics over the last century. Key moments include Planck’s proposal of quanta (1900), the advent of quantum field theory (1928), the development of quantum algorithms (1994), and the discovery of the Higgs boson that completed the Standard Model (2012).", position: bottom, scope: "parent")
...
#v-image(path: "/images/blackbody.svg", caption: "Comparison of classical and quantum predictions for blackbody radiation. The classical Rayleigh–Jeans law (pink curve) incorrectly predicts an infinite amount of emitted energy at short wavelengths, leading to the ultraviolet catastrophe. Max Planck resolved this paradox by assuming energy is emitted in discrete quanta, giving rise to the correct spectrum (violet curve).", position: top)

== Expanding Domains: From Quantum Field Theory to Beyond
...
#v-image(path: "/images/field.png", caption: "The central idea of quantum field theory (QFT) is that particles are not standalone entities, but localized excitations of underlying quantum fields permeating space. Each fundamental particle such as an electron, photon, or quark is associated with a specific quantum field that vibrates at every point in space and time. Interactions between particles arise from the interplay between these fields, such as when the electromagnetic field mediates forces between charged particles.", position: bottom)
...
#v-image(path: "/images/bird.svg", caption: "A conceptual diagram of how quantum entanglement may enable migratory birds to sense the Earth’s magnetic field. A radical pair of electrons is formed in the bird’s eye; these electrons respond to magnetic fields and undergo transitions in the retina, leading to modified concentration of chemical output compounds and provides sensory signals. Adapted from [47].", position: bottom, scope: "parent")
...
#v-image(path: "/images/secondQuantum.png", caption: "Requirements and Realizations of Qubits in the Second Quantum Revolution. This diagram summarizes the central criteria a physical system must meet to function as a viable qubit (inner circle), alongside a range of physical platforms where qubits have been implemented (outer circle). Core requirements include the ability to initialize qubits in a known state, apply fast and precise quantum gates, maintain coherence long enough for computation, and read out results with high fidelity. Adapted from [48].", position: top)
