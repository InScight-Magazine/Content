...
#let reviewedBy = ("Ayan B", "Chitradeep S", "Budhaditya B", "Sukalyan D") 
...
#img(path: "/images/SNpicture2.jpeg", caption: "Pleiotropic functions of (E)-β-caryophyllene in maize plants and several interacting organisms, including leaf herbivore (_Spodoptera littoralis_) larval parasitoid (_Cotesia marginiventris_), western corn rootworm (_Diabrotica virgifera_) and entomopathogenic nematode (_Heterorhabditis megidis_). (Munawar _et al.,_ 2023)", position: top, width: 50%)
