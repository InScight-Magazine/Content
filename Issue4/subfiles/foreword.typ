...
#place(
  ...
  grid(
    ...
    figure(image("/covers/digestCover.png"), caption: [In this experiment, two laser frequency combs—one on each end of a 113 km open-air path—beam precisely timed light pulses across the atmosphere to detect gases like CO₂ and H₂O with extraordinary precision. Read the relevant #pageLink(<digest-Debanuj>, [writeup by Debanuj Chatterjee]).], supplement: "", numbering: none)
  ) +
  v(2em) +
  grid(
    columns: (1.8fr, 1.2fr),
