...
#let nonCoverTitle(
  ...
  place(
    ...
    [
      #v(1em)
      #if locator != none [
        = #heading(outlined: false)[#title]#label(locator)
      ] else [
  ...
  if outlined == true {
    show heading: none
    heading(outlined: true, text(fill: outline-headings-color, weight: "bold", size: outline-title-size, font: header-font, title) + if outlineDesc != none [#text(fill: outline-headings-color, size: outline-desc-size, font: header-font, )[#upper[#outlineDesc]]])
  }
}
  ...
  page(
    ...
    #block[
      #image(coverImage, width: 100%, height: 50%)
        ...
        #place(bottom + right, box(width: 45%, fill: rgb(0, 0, 0, 200), inset: 0.5em, text(font: alternate-font, size: main-size - 1pt, fill: rgb(240, 240, 240), weight: "semibold", coverCaption)))
      ]
    ]
    #rect(
      width: 100%,
    ...
    #show heading.where(level: 1): it => [
      ...
      {
        show heading: none
        heading(outlined: true, text(fill: outline-headings-color, weight: "bold", size: outline-title-size, font: header-font, title) + if outlineDesc != none [#text(fill: outline-headings-color, font: header-font, size: outline-desc-size)[#upper[#outlineDesc]]])
      }
    }
...
#let img(
  ...
  place(
    ...
    rect(
      ...
      caption: if caption != none {
        figure.caption(position: bottom, text(eval(mode: "markup", caption)))
      }
    )
    ]
  )
  ...
  place(
    ...
    rect(fill: image-bg-color, inset: image-caption-gap)[
      ...
      if caption.len() > 0 {
        align(image-caption-align)[#figure-suppl #context {counter(figure.where(kind: image)).display()}: #eval(mode: "markup", caption)]
      } else {
        none
      }
    )
